        ...
        <div className='w-full min-h-screen bg-[url("https://oneqid.com/wp-content/uploads/2023/09/grid-for-video.png")] bg-cover bg-center border-b-[1px] border-slate-800'>
            <div className='w-full min-h-screen bg-black/80'>
                <div className='px-8 py-16 md:px-[50px] md:mt-0'>
                    {/* Section 1  */}
                    <div className='md:flex md:justify-between md:items-center lg:mx-10 xl:mx-20'>
                        ...
                        <div className='my-4 '>
                            ...
                            <div className=''>
                                ...
                                {/* pc version  */}
                                <div className='mt-[-30px] hidden md:absolute md:w-[450px] md:right-[2%] md:px-3 md:flex md:gap-[4%] lg:w-[600px] lg:gap-14 lg:right-[4%]'>
                    ...
                    <div className='md:mt-[50px] lg:mx-10 xl:mx-20 xl:mt-[-40px]'>
                        ...
                        {/* First row section */}
                        <div className='border-l-4 border-green-400 md:pt-8 md:pb-14'>
                            {/* head1 para1 */}
                        ...
                        {/* second row section  */}
                        <div className='border-l-4 border-orange-400 md:my-8'>
                            {/* head2 para2  */}
                            <div className='pl-3 md:pl-10 py-3 text-3xl font-medium text-[#BABABA] md:text-4xl md:mt-7 lg:text-5xl'>
                            ...
                            <p className='pl-3 md:pl-10 text-[15px] font-semibold text-[#747373] md:text-xl'>
